...
<body class="bg-slate-200 font-sans text-gray-900">
    ...
    <!-- NAV -->
    <nav
        class="fixed top-0 left-0 right-0 z-[1000] bg-white/97 backdrop-blur-md border-b border-gray-200 flex items-center justify-between px-5 h-[54px]">
        <!-- Logo -->
        <div class="flex items-center gap-2">
            <div
                class="w-[30px] h-[30px] rounded-lg bg-gradient-to-br from-blue to-teal flex items-center justify-center text-xs text-white font-extrabold font-mono">
                AL</div>
    ...
    <!-- FLOATING PANEL -->
    <div class="float-panel fixed left-1/2 -translate-x-1/2 z-[500] w-[min(680px,calc(100vw-32px))] bg-white/97 backdrop-blur-lg border border-gray-200 rounded-2xl shadow-2xl overflow-hidden"
        style="top: calc(54px + 14px)">

        <!-- Header (always visible) -->
        <div id="panelHeader"
            class="flex items-center justify-between px-4 py-3 cursor-pointer select-none border-b border-transparent hover:bg-gray-50/50 transition-colors"
            onclick="togglePanel()">
            <div class="flex items-center gap-2.5">
                <div class="w-2 h-2 rounded-full bg-danger-DEFAULT flex-shrink-0 animate-blink-slow"
